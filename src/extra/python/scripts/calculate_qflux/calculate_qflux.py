...
if __name__ == "__main__":
    ...
    # Proposed name of your output qflux file. Will also be qflux field name in q-flux netcdf file as the fortran
    # assumes file-name = field name. No need to add '.nc' or any file paths in this variable as otherwise they
    # will end up in the field name too. Output file will be stored in the same directory as this script.
    output_file_name = 'ami_test_interp'

    start_file = 240
    end_file = 360
    land_present = True
    # Conditions the script on whether to expect data on sigma levels (if False) or pressure levels (if True).
